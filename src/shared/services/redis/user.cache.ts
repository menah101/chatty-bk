import { IUserDocument, INotificationSettings, ISocialLinks, } from '@root/features/user/interfaces/user.interface';
import { ServerError } from '@global/helpers/error-handle';
